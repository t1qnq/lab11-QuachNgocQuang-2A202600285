...
def topic_filter(user_input: str) -> bool:
    ...
    # Step 1: If input contains any blocked topic -> block immediately
    for block in BLOCKED_TOPICS:
        if block in input_lower:
            return True

    # Step 2: If input contains an allowed topic -> allow
    for allow in ALLOWED_TOPICS:
        if allow in input_lower:
            return False

    # Step 3: Off-topic -> block
    return True
...
class InputGuardrailPlugin(base_plugin.BasePlugin):
    ...
    async def on_user_message_callback(
        ...
        *,
        ...
        # Check 2: Topic filter (off-topic or blocked topic)
